...
variable "lock_level" {
  type        = string
  description = "(Optional) Specifies the Level to be used for this RG Lock. Possible values are Empty (no lock), CanNotDelete and ReadOnly."
  validation {
...
variable "lock_notes" {
  type        = string
  description = "(Optional) Sets a description on the Resource Group Lock."
